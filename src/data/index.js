...
export const projects = [
  {
    title: 'E-Commerce Platform',
    description: 'Full-stack e-commerce app with product catalog, cart, Stripe payments, and an admin dashboard.',
    tech: ['ASP.NET Core', 'React', 'SQL Server', 'Redis'],
    image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=800&q=80',
    github: 'https://github.com',
    live: 'https://example.com',
  },
  {
    ...
    description: 'RESTful API for a Kanban board with JWT auth, real-time updates via SignalR, and role-based access control.',
  ...
  {
    title: 'Blog CMS',
    description: 'Content management system with rich-text editor, image uploads, SEO metadata, and a Next.js frontend.',
  ...
  {
    title: 'Real-Time Chat App',
    description: 'WebSocket-based chat application with rooms, online presence, and message history using SignalR.',
    tech: ['ASP.NET Core', 'SignalR', 'React', 'Redis'],
    image: 'https://images.unsplash.com/photo-1611606063065-ee7946f0787a?w=800&q=80',
    github: 'https://github.com',
    live: null,
  },
  {
    ...
    description: 'Admin analytics dashboard with charts, data tables, filters, and role-based views built in Angular.',
  ...
  {
    title: 'Auth Microservice',
    description: 'Standalone authentication service with OAuth2, JWT refresh tokens, email verification, and Docker deployment.',
    tech: ['ASP.NET Core', 'OAuth2', 'JWT', 'Docker'],
    image: 'https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?w=800&q=80',
    github: 'https://github.com',
    live: null,
